...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var arregloNuevo = array.map(function(x){
      return x + 1
   })
   return arregloNuevo
}
...
function numeroMasGrande(arrayOfNums) {
   ...
   if ( arrayOfNums [ i ] >  arrayOfNums [ i + 1]){
      numeroGrande.push(arrayOfNums[ i ])
   }
   return numeroGrande[0]
}
...
function empiezaConNueve(num) {
   ...
   var numero2 = numero1.split ("")
   
   if ( numero2[0] === "9" ) return true
   return false;
